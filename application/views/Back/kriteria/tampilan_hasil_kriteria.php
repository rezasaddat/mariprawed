...
<a class="uk-button uk-button-default" href="<?=base_url('Kriteria')?>" class="bt_blue"><span class="bt_blue_lft"></span><strong>Daftar Prioritas Kriteria</strong><span class="bt_blue_r"></span></a>	
<br />
<div>
